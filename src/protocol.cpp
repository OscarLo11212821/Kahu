...
void Protocol::send_hello() {
    ...
    std::cout << "capabilities ping sync hello halt search go board move eval status legal nnue tt threads"
              << std::endl;
    send_nnue_info();
    std::cout << "threads " << engine.threads() << std::endl;
